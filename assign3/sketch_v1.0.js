...
function draw() {
  ...
  fill('#262b34');
  noStroke();
  quad(-70, 100, 70, 100, 250, 180, -250, 180);
  rect(-250, 180, 500, 200);
  fill('#FFFFFF');
  rect(-70, 100, 140, 200);
  fill('#f2d8c4');
  triangle(-70, 100, 70, 100, 0, 180);
  
  // 넥타이
  fill('#344774');
  quad(0, 180, 24, 200, 0, 240, -24, 200);
  ...
  fill('#444444');
  strokeWeight(1);
  // quad(0+noseX, 0+noseY,  6*noseSize+noseX, 6*noseSize+noseY, 2*noseSize+noseX, 8*noseSize+noseY, -2*noseSize+noseX, 2*noseSize+noseY);
  rotate(radians(55));
...
//   strokeWeight(6);
//   arc(0, 30, 120, 100, radians(90-15), radians(90+15));

//   strokeWeight(5);
//   arc(0, 30, 120, 100, radians(45+15), radians(45+15+15));
//   arc(0, 30, 120, 100, radians(120-15), radians(120));
//   strokeWeight(4);
//   arc(0, 30, 120, 100, radians(45), radians(45+20));
//   arc(0, 30, 120, 100, radians(110), radians(120+10));

...
var tongClicked = 0; // 혀가 얼마나 뻗어나왔는지
var tongueDir = 1;       // 혀가 나오는 방향 (1: 나오기, -1: 들어가기)
...
function draw() {
  ...
  tongClicked += tongueDir * 0.3; 
  if (tongClicked >= 10) {
    tongueDir = -1;
  } else if (tongClicked <= -3) {
    tongueDir = 1; 
  }
  ...
  noStroke();
  fill('#ffc0cb');       
  rect(-20, 77, 20, tongClicked); 
  arc(-10, 77 + tongClicked, 20, 20, 0, PI);

  // 혀 가운데
  stroke('#d68d84');
  strokeWeight(3);
  line(-9, 77, -10, 77 + tongClicked + 1);  
